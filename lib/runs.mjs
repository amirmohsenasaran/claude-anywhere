...
export function startRun({ sessionId, cwd, prompt, images = [], model, permissionMode, effort, disabledMcp = [] }) {
  ...
  run.controls = { permissionMode: PERMISSION_MODES.includes(permissionMode) ? permissionMode : 'default', model: models.acceptable(model), effort: EFFORTS.includes(effort) ? effort : '' };

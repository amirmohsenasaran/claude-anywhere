...
function providerVars(p) {
  ...
  if (p.model) { e.ANTHROPIC_MODEL = p.model; e.ANTHROPIC_DEFAULT_SONNET_MODEL = p.model; e.ANTHROPIC_DEFAULT_OPUS_MODEL = p.model; e.ANTHROPIC_DEFAULT_HAIKU_MODEL = p.model; }
  return e;
}
